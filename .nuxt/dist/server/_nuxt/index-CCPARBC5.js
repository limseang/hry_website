...
import { _ as _sfc_main$2 } from "./ServiceCard-DRXJDV-f.js";
      ...
      if (unref(testimonials).length) {
        ...
        ssrRenderList(unref(testimonials), (t) => {
          ...
          if (t.avatar_url) {
            ...
            _push(`<span class="font-display font-900 text-xl text-blue-500">${ssrInterpolate(t.name?.charAt(0))}</span>`);
          }
...
//# sourceMappingURL=index-CCPARBC5.js.map
