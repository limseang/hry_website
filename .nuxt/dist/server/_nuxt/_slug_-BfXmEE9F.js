  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        if (unref(product).size_options?.length) {
        ...
        if (unref(product).finishing_options?.length) {
        ...
        if (unref(product).color_options?.length) {
...
//# sourceMappingURL=_slug_-BfXmEE9F.js.map
