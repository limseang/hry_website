  ...
  setup(__props) {
    ...
    useHead(() => {
      ...
      return {
        ...
        meta: [{ name: "description", content: (_a = service.value) == null ? void 0 : _a.short_description }]
      };
    });
    const icons = {
    ...
    const iconD = computed(() => {
      var _a;
      return getIcon((_a = service.value) == null ? void 0 : _a.icon);
    });
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (unref(loading)) {
        ...
        if ((_a = unref(service).images_url) == null ? void 0 : _a.length) {
        ...
        if ((_b = unref(service).features) == null ? void 0 : _b.length) {
...
//# sourceMappingURL=_slug_-DTYf_0AX.mjs.map
