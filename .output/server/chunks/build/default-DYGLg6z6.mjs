import { a as _export_sfc, _ as __nuxt_component_1, c as useRoute } from './server.mjs';
import { _ as _sfc_main$3 } from './BrandLogo-BIMtJ2Cx.mjs';
import { mergeProps, defineComponent, withCtx, createTextVNode, toDisplayString, computed, ref, watch, unref, createVNode, openBlock, createBlock, getCurrentScope, onScopeDispose, useSSRContext } from 'vue';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--]--></ul></div></div><div class="pt-7 flex flex-col sm:flex-row items-center justify-between gap-4"><p class="font-mono text-mist text-xs">\xA9 ${ssrInterpolate((/* @__PURE__ */ new Date()).getFullYear())} HRY Printing. All rights reserved.</p><div class="flex gap-6">`);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/about",
...
//# sourceMappingURL=default-DYGLg6z6.mjs.map
